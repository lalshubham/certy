use super::lifecycle::{trigger_app_close, update_window_title};
use super::App;
use crate::config::{
    SCROLLBAR_THICKNESS, SIDEBAR_MIN_WIDTH, TAB_BAR_HEIGHT, TERMINAL_TAB_BAR_HEIGHT,
    WINDOW_MIN_HEIGHT, WINDOW_MIN_WIDTH,
};
use crate::input::{self, ActionEvent, AppEvent};
use crate::session::{
    get_window_session_state, recovery_dir, recovery_file_name, save_session, update_window_size,
};
use crate::sidebar::MenuItem;
use crate::ui::{compute_layout, Renderer};
use std::fs;
